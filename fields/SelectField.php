...
class SelectField extends Field {
  ...
  public function setValue($value){
    ...
    else {in_array($value,$values)?$this->selected = $value:null;}
  }
  ...
  public function create_field(){
    ...
    foreach($this->choices as $key=>$choice){
      if($key == $this->selected || ($this->multiple && is_array($this->selected) && in_array($key,$this->selected))) $selected = "selected";
